...
### Directory Structure
- **i3/** - i3 helper scripts for window management (the i3 config is Home Manager-owned)
...
- Config: generated by Home Manager from `modules/apps/i3wm/` in the `Bad3r/nixos` flake, not tracked here
- Scripts: `i3/scripts/` for utilities
- Keybindings defined with `bindsym`
- Status bar: i3blocks with custom scripts

### Kitty Terminal
- Main config: generated by Home Manager from `modules/hm-apps/kitty.nix` in the flake, not tracked here
- Colors come from Stylix; the theme files in `kitty/` are legacy and not included by the generated config
- Supports image preview and diff viewing

### Rofi
- Config: generated by Home Manager from `modules/hm-apps/rofi.nix` in the flake, not tracked here
